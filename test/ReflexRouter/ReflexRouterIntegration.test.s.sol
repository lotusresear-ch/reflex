...
contract ReflexRouterIntegrationTest is Test {
    ...
    function setUp() public {
        ...
        poolBC_V2.setAuthorizedCaller(address(reflexRouter), true);
        poolBC_V3.setAuthorizedCaller(address(reflexRouter), true);
        poolBA_V2.setAuthorizedCaller(address(reflexRouter), true);
        poolCA_V2.setAuthorizedCaller(address(reflexRouter), true);
        poolAD_V3.setAuthorizedCaller(address(reflexRouter), true);
        poolAD_V2.setAuthorizedCaller(address(reflexRouter), true);
        poolDA_V2.setAuthorizedCaller(address(reflexRouter), true);
        poolCD_V2.setAuthorizedCaller(address(reflexRouter), true);
    ...
    function test_gas_usage_simple_arbitrage() public {
        ...
        quoter.addRoute(
            address(poolAB_V2), 0, swapAmount, expectedProfit, pools, dexTypes, dexMeta, tokens, amounts, 0
        );
